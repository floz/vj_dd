...
void main() {
	...
	finalPosition.y += dispCurr.b * stry * spacialStrCurr * speedEffect * .5;// * sin( time * .25 + vUv.x );
	prevPos.y += dispPrevious.b * stry * spacialStrPrev * speedEffect * .5;// * sin( time * .25 + vUv.x );
	nextPos.y += dispNext.b * stry * spacialStrNext * speedEffect * .5;// * sin( time * .25 + vUv.x );
