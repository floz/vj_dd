...
const curlNoise3D = module.exports.curlNoise3D = function(p) {
    ...
    return new THREE.Vector3(
    (p_y1.z - p_y0.z - p_z1.y + p_z0.y) * divisor, (p_z1.x - p_z0.x - p_x1.z + p_x0.z) * divisor, (p_x1.y - p_x0.y - p_y1.x + p_y0.x) * divisor).normalize()
} 
